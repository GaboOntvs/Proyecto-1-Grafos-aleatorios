...
//Parece haber error porque solo conserva el peso de la última arista incidente a "v"
        }
    }
    ...
    { /*excepción
        ...
        //genErdosRenyi(500,300,true,false);
        //genGilbert(500,0.15,true,false);
        //genGeografico(500,0.15,true,false);
        grafoG=genBarabasiAlbert(500,10,true,false);
